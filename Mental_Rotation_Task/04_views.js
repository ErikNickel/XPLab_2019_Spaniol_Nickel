...
const instructions = babeViews.instructions({
    ...
    text:  `This is a sample instructions view.
            <br />
            <br />
            You will always see two images and have to judge if they show the same or different figures.`,
...
// initialize the key press task

const key_press = babeViews.keyPress({
  trials: key_press_trials.key_press_choice.length,
  name: 'key_press',
  trial_type: 'key_press',
  data: _.shuffle(key_press_trials.key_press_choice)
